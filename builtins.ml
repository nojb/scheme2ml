let builtins =
  ["procedure?", None, [1, "Scheme.is_procedure"];
   ...
   "eq?", None, [2, "Scheme.is_eq"]; "eqv?", None, [2, "Scheme.is_eqv"];
   "equal?", None, [2, "Scheme.is_equal"]; "car", None, [1, "Scheme.car"];
   "cdr", None, [1, "Scheme.cdr"]; "caar", None, [1, "Scheme.caar"];
   "cadr", None, [1, "Scheme.cadr"]; "cddr", None, [1, "Scheme.cddr"];
   "cdar", None, [1, "Scheme.cdar"]; "caaar", None, [1, "Scheme.caaar"];
   "caddr", None, [1, "Scheme.caddr"]; "cdadr", None, [1, "Scheme.cdadr"];
   "cdddr", None, [1, "Scheme.cdddr"]; "caadr", None, [1, "Scheme.caadr"];
   "cadddr", None, [1, "Scheme.cadddr"];
   "display", None, [1, "Scheme.display"];
   "write", None, [1, "Scheme.display"]; "zero?", None, [1, "Scheme.is_zero"];
   "integer?", None, [1, "Scheme.is_integer"];
   "number?", None, [1, "Scheme.is_number"]; "=", Some (2, "Scheme.eq"), [];
   "<", Some (2, "Scheme.lt"), []; ">", Some (2, "Scheme.gt"), [];
   "<=", Some (2, "Scheme.le"), []; ">=", Some (2, "Scheme.ge"), [];
   "newline", None, [0, "Scheme.newline"; 1, "Scheme.newline_to_port"];
   "write-char", None,
   [1, "Scheme.write_char"; 2, "Scheme.write_char_to_port"];
   "read", None, [0, "Scheme_io.read"; 1, "Scheme_io.read_from_port"];
   "read-char", None,
   [0, "Scheme_io.read_char"; 1, "Scheme_io.read_char_from_port"];
   "peek-char", None,
   [0, "Scheme_io.peek_char"; 1, "Scheme_io.peek_char_from_port"];
   "eof-object?", None, [1, "Scheme_io.is_eof_object"];
   (*("char-ready?", None, [(0, "Scheme_io.is_char_ready"), (1,
     "Scheme_io.is_char_ready_on_port")]);*)
   "number->string", None, [1, "Scheme.number_to_string"];
   "boolean?", None, [1, "Scheme.is_boolean"];
   "not", None, [1, "Scheme._not"]; "pair?", None, [1, "Scheme.is_pair"];
   "cons", None, [2, "Scheme.cons"];
   "set-car!", None, [2, "Scheme.set_car_bang"];
   "set-cdr!", None, [2, "Scheme.set_cdr_bang"];
   "null?", None, [1, "Scheme.is_null"]; "map", Some (1, "Scheme.map"), [];
   "for-each", Some (1, "Scheme.for_each"), [];
   "list?", None, [1, "Scheme.is_list"]; "list", Some (0, "Scheme.list"), [];
   ...
   "list-ref", None, [2, "Scheme.list_ref"]; "memq", None, [2, "Scheme.memq"];
   "memv", None, [2, "Scheme.memv"]; "member", None, [2, "Scheme.member"];
   "assq", None, [2, "Scheme.assq"]; "assv", None, [2, "Scheme.assv"];
   ...
   "force", None, [1, "Scheme.force"]; "error", Some (1, "Scheme.error"), []]
